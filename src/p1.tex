...
%<<<<<< release1
		...
		\subsubsection{TrackCIS est un outil qui permet la supervision des flux}
			...
			Les principales fonctionnalités de TrackCIS sont :
			\begin{itemize}
			...
			\end{itemize}
			Rappelons que chaque message peut contenir des données médicales ou
			administratives utilent pour le tratement des patients.
