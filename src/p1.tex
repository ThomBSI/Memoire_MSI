...
hospitalières}
	...
	\subsection{TrackCIS est une console de supervision de l'EAI Cloverleaf}
		...
		\subsubsection{Les flux de messages doivent être surveillés}
			...
			service hospitalier risque d'en pâtir, ce qui aura des conséquences sur le
		...
		\subsubsection{TrackCIS est un outil qui permet la supervision des flux}
			...
			\begin{itemize}
			  ...
			  coupure momentanée du réseau peu bloquer les messages qui transitant à ce
	...
	\subsection{TrackCIS est au cœur d'une problématique commerciale pour Xperis}
		...
		\subsubsection{Xperis cherche à établir des liens directs avec les hôpitaux}
			...
			Cloverleaf, sont les établissements hospitaliers français. Au 31 décembre
		...
		\subsubsection{Un outil qui se vend mal et qui est peu utilisé}
			...
			une des application (par exemple un patient enregistré à l'accueil mais dont
			...
			intermédiaires et donc de diminuer le temps de résolution des problèmes.
			...
			multiple et relativement méconnue d'Xperis. L'une d'elles est que la console
	...
	\subsection{Vers une nouvelle version de TrackCIS}
		...
		\subsubsection{Un module statistique lié aux évolutions de Cloverleaf}
			...
			inconnues. Cependant, l'une d'elle pourrait consister en l'implémentation
			...
			\begin{itemize}
			  ...
			  de console de supervision utilisent pleinement à ce jour. Un module
		...
		\subsubsection{Méthodologie générale du projet}
			...
			chacune de ces étapes nous serons amenés  modéliser différents aspects de
			l'application :
			\begin{itemize}
			  \item Modélisation des fonctions de l'application. Nous établirons une
			  liste des fonctionnalités que devra comporter la solution finale. Nous
			  établirons cette liste à partir des besoins des utilisateurs.
			...
			méthodologie qui nous permettra d'une part de connaitre les besoins des
